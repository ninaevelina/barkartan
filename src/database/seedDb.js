...
const seedBarDb = async () => {
  try {
    ...
    await sequelize.query(`
        INSERT INTO bar (name, address, description, fk_city_id, phone, website, hours, reviews, rating) VALUES
    ...
    await sequelize.query(
      ...
      ('lisamansson','12345','lisa@mi.se','site_admin'),
      ('juliac','password123','juliac@mi.se','bar_admin'),
